...
function do_add(){
    ...
    if (contacts == '') {
            $("#contactsdiv").addClass("has-error");
            var n = noty({
              text: "请选择客户联系人",
              type: 'error',
              layout: 'center',
    ...
    if (project_man == '') {
            $("#project_mandiv").addClass("has-error");
            var n = noty({
              text: "请输入工程项目负责人",
              type: 'error',
              layout: 'center',
    ...
    if (project_mobile == '') {
            $("#project_mobilediv").addClass("has-error");
            var n = noty({
              text: "请输入工程项目负责人联系电话",
              type: 'error',
              layout: 'center',
    ...
    if (business_man == '') {
            $("#business_mandiv").addClass("has-error");
            var n = noty({
              text: "请输入日常业务负责人",
              type: 'error',
              layout: 'center',
    ...
    if (business_mobile == '') {
            $("#business_mobilediv").addClass("has-error");
            var n = noty({
              text: "请输入日常业务负责人联系电话",
              type: 'error',
              layout: 'center',
